        ...
        <form action="{{ route('rekrutmen.kandidat_lanjut_user.update', $data) }}" method="POST">
            ...
            <h3 class="mb-4 text-lg font-semibold text-gray-800 dark:text-white">
                ...
                <div class="col-span-2 space-y-4"
                    x-data="{ 
                    interviews: {{ old('detail_interview') ? json_encode(old('detail_interview')) : (is_array($data->detail_interview) ? json_encode($data->detail_interview) : $data->detail_interview ?? '[]') }} 
                    }">
