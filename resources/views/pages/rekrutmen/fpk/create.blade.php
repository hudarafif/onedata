...
<div class="mx-auto max-w-5xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Pengajuan FPK Baru</h1>
            <p class="mt-2 text-gray-600 dark:text-gray-400">Isi formulir di bawah untuk mengajukan kebutuhan karyawan baru</p>
        </div>
    ...
    <form action="{{ route('rekrutmen.fpk.store') }}" method="POST" id="fpkForm">
        @csrf
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="nama_jabatan" required value="{{ old('nama_jabatan') }}" placeholder="Cth: Staff Akuntansi"
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi_kerja" required value="{{ old('lokasi_kerja') }}" placeholder="Cth: Head Office Jakarta"
                               class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        ...
                        <div class="relative">
                            <input type="date" name="tanggal_mulai_bekerja" required value="{{ old('tanggal_mulai_bekerja') }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="jumlah_kebutuhan" required min="1" value="{{ old('jumlah_kebutuhan', 1) }}"
                                   class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                    ...
                    <div>
                        ...
                        <input type="text" name="grade" value="{{ old('grade') }}" placeholder="Diisi oleh Finance"
                               class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                    </div>
                </div>
                <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2.5 px-4 text-sm text-gray-700 dark:text-gray-300 transition hover:border-blue-400 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-600 dark:hover:bg-blue-900/20 select-none">
                            <input type="radio" name="level" value="{{ $lvl }}" {{ old('level') == $lvl ? 'checked' : '' }} required class="text-blue-600 focus:ring-blue-500" />
                            {{ $lvl }}
                        </label>
                        @endforeach
                    </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2.5 px-4 text-sm text-gray-700 dark:text-gray-300 transition hover:border-yellow-400 hover:bg-yellow-50 dark:border-gray-700 dark:hover:border-yellow-600 dark:hover:bg-yellow-900/20 select-none">
                            ...
                            <input type="hidden" />
                            {{ $alasan }}
                            <input type="checkbox" data-alasan="{{ $alasan }}" value="{{ $alasan }}" {{ old('alasan_permintaan') == $alasan ? 'checked' : '' }} class="sr-only" onchange="handleAlasan(this)" />
                        </label>
                        @endforeach
                    </div>
                    <input type="hidden" name="alasan_permintaan" id="alasan_permintaan_hidden" value="{{ old('alasan_permintaan') }}" />
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="nama_karyawan_pengganti" value="{{ old('nama_karyawan_pengganti') }}" placeholder="Nama karyawan yang digantikan"
                               class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                    </div>
                    <div>
                        ...
                        <input type="text" name="jangka_waktu_kontrak" value="{{ old('jangka_waktu_kontrak') }}" placeholder="Cth: 6 Bulan / 1 Tahun"
                               class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                    </div>
                </div>
                <div>
                    ...
                    <textarea name="dampak_kekurangan_posisi" rows="3" placeholder="Uraikan dampak jika posisi ini tidak segera diisi..."
                              class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 resize-none">{{ old('dampak_kekurangan_posisi') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="p-6 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2.5 px-4 text-sm text-gray-700 dark:text-gray-300 transition hover:border-green-400 hover:bg-green-50 dark:border-gray-700 dark:hover:border-green-600 dark:hover:bg-green-900/20 select-none">
                                <input type="radio" name="sumber_rekrutmen" value="{{ $src }}" {{ old('sumber_rekrutmen') == $src ? 'checked' : '' }} required class="text-green-600 focus:ring-green-500" />
                                {{ $src }}
                            </label>
                            @endforeach
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="catatan_khusus" value="{{ old('catatan_khusus') }}" placeholder="Catatan tambahan..."
                               class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                    </div>
                </div>
                <div>
                    ...
                    <textarea name="deskripsi_jabatan" rows="3" placeholder="Uraian singkat tentang jabatan ini..."
                              class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 resize-none">{{ old('deskripsi_jabatan') }}</textarea>
                </div>
                <div>
                    ...
                    <div class="flex gap-3 items-center mb-2">
                        ...
                        <input type="text" name="tanggungjawab_jabatan[]" value="{{ old("tanggungjawab_jabatan.$i") }}" placeholder="Tanggung jawab ke-{{ $i+1 }}"
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="flex gap-3 items-center mb-2">
                            <span class="text-sm text-gray-400 w-5 text-right">{{ $i+1 }}.</span>
                            <input type="text" name="tugas[]" value="{{ old("tugas.$i") }}" placeholder="Tugas ke-{{ $i+1 }}"
                    ...
                    <div>
                        ...
                        <div class="flex gap-3 items-center mb-2">
                            <span class="text-sm text-gray-400 w-5 text-right">{{ $i+1 }}.</span>
                            <input type="text" name="tolak_ukur_keberhasilan[]" value="{{ old("tolak_ukur_keberhasilan.$i") }}" placeholder="Indikator ke-{{ $i+1 }}"
                                   class="h-9 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                        </div>
                        @endfor
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2 px-3 text-sm text-gray-700 dark:text-gray-300 transition hover:border-blue-400 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-600 dark:hover:bg-blue-900/20 select-none">
                                <input type="radio" name="kualifikasi_jk" value="{{ $jk }}" {{ old('kualifikasi_jk', 'Bebas') == $jk ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500" />
                                {{ $jk }}
                            </label>
                            @endforeach
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2 px-3 text-sm text-gray-700 dark:text-gray-300 transition hover:border-blue-400 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-600 dark:hover:bg-blue-900/20 select-none">
                                <input type="radio" name="kualifikasi_usia" value="{{ $usia }}" {{ old('kualifikasi_usia') == $usia ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500" />
                                {{ $usia }}
                            </label>
                            @endforeach
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2 px-3 text-sm text-gray-700 dark:text-gray-300 transition hover:border-blue-400 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-600 dark:hover:bg-blue-900/20 select-none">
                                <input type="radio" name="kualifikasi_pendidikan" value="{{ $pend }}" {{ old('kualifikasi_pendidikan') == $pend ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500" />
                                {{ $pend }}
                            </label>
                            @endforeach
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2 px-3 text-sm text-gray-700 dark:text-gray-300 transition hover:border-blue-400 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-600 dark:hover:bg-blue-900/20 select-none">
                                <input type="radio" name="kualifikasi_pengalaman" value="{{ $exp }}" {{ old('kualifikasi_pengalaman') == $exp ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500" />
                                {{ $exp }}
                            </label>
                            @endforeach
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="kualifikasi_jurusan" value="{{ old('kualifikasi_jurusan') }}" placeholder="Cth: Teknik Informatika, Akuntansi, semua jurusan"
                               class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="flex gap-2 items-center mb-2">
                            ...
                            <input type="text" name="hard_competency[]" value="{{ old("hard_competency.$i") }}" placeholder="Kompetensi teknis ke-{{ $i+1 }}"
                                   class="h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                        </div>
                        @endfor
                    </div>
                    <div>
                        ...
                        <div class="flex gap-2 items-center mb-2">
                            <span class="text-sm text-gray-400 w-4">{{ $i+1 }}.</span>
                            <input type="text" name="soft_competency[]" value="{{ old("soft_competency.$i") }}" placeholder="Soft skill ke-{{ $i+1 }}"
                                   class="h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                        </div>
                        @endfor
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2 px-3 text-sm text-gray-700 dark:text-gray-300 transition hover:border-blue-400 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-600 dark:hover:bg-blue-900/20 select-none">
                                <input type="checkbox" name="test_dibutuhkan[]" value="{{ $test }}" {{ in_array($test, old('test_dibutuhkan', [])) ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500 rounded" />
                                {{ $test }}
                            </label>
                            @endforeach
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 py-2 px-3 text-sm text-gray-700 dark:text-gray-300 transition hover:border-blue-400 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-600 dark:hover:bg-blue-900/20 select-none">
                                <input type="checkbox" name="sarana_prasarana[]" value="{{ $sarana }}" {{ in_array($sarana, old('sarana_prasarana', [])) ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500 rounded" />
                                {{ $sarana }}
                            </label>
                            @endforeach
                        </div>
        ...
        <!-- Info Alur -->
        <div class="mb-5 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
            <p class="text-sm text-blue-800 dark:text-blue-400">
                <strong>Info Alur:</strong> Setelah diajukan, FPK akan masuk ke <strong>HR Admin</strong> untuk diperiksa, kemudian diteruskan ke <strong>HR Manager</strong> untuk disetujui atau ditolak.
            </p>
        </div>
