                ...
                <div class="relative bg-white/95 dark:border dark:bg-gray-900/95 rounded-2xl shadow-xl p-6 sm:p-8">
                    <div>
                        <div class="mb-6 text-center">
                            <div class="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-white border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
                                <img src="{{ asset('images/logo/logo.png') }}" class="w-full h-full object-contain p-2" alt="Logo" />
                            </div>
