...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            @can('deleteTempaKelompok')
            <form action="{{ route('tempa.kelompok.bulk-delete') }}" method="POST" id="bulkDeleteForm" class="inline-block"
                ...
                <button type="submit" x-show="hasSelection" x-cloak
                        onclick="return confirm('Apakah Anda yakin ingin menghapus kelompok yang dipilih?')"
