    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">
                    Form untuk menambahkan Peserta TEMPA baru
            </p>
        </div>
    ...
    <form action="{{ route('tempa.peserta.store') }}" method="POST" class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
                ...
                <select name="status_peserta" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
            ...
            <div>
                ...
                <select name="kelompok_id" id="kelompok_id" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                    ...
                    <option value="{{ $kelompok->id_kelompok }}" data-mentor="{{ $kelompok->nama_mentor }}" {{ old('kelompok_id') == $kelompok->id_kelompok ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="text" id="nama_mentor" name="nama_mentor" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs focus:border-blue-500 focus:outline-hidden focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" readonly placeholder="Otomatis terisi dari kelompok">
            </div>
            @else
            <div>
                <label class="mb-2.5 block text-sm font-medium text-gray-900 dark:text-white">Kelompok <span class="text-red-500">*</span></label>
