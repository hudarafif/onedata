...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-gray-600 dark:text-gray-400">
            Tambahkan data perusahaan baru ke dalam sistem
        </p>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-6" x-data="{ holding_id: '{{ old('holding_id') }}' }">
