    ...
    <nav class="mb-6">
        <ol class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li class="flex items-center gap-2">
                ...
                <span class="text-gray-900 dark:text-white">Detail Departemen</span>
            </li>
        </ol>
    </nav>
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
                Informasi detail departemen dan struktur unit.
            </p>
        </div>
    ...
    <div class="grid grid-cols-1 gap-6">
        <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Nama Departemen</label>
                    <p class="mt-1 text-base font-semibold text-gray-900 dark:text-white">{{ $department->name }}</p>
                </div>
                <div>
                    ...
                    <p class="mt-1 text-base text-gray-900 dark:text-white">
                        @if($department->division)
                             ...
                             @if($department->division->company)
                                <span class="text-sm text-gray-500">({{ $department->division->company->name }})</span>
                             @endif
                        @else
        ...
        <div x-data="departmentDetails()" class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-between gap-4">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Daftar Unit</h2>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('organization.unit.create', ['department_id' => $department->id]) }}"
                        ...
                        <template x-for="(item, index) in filteredItems" :key="item.id">
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition">
                                ...
                                <td class="px-5 py-4 text-center">
                                    <a :href="'{{ url('organization/unit') }}/' + item.id" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium inline-flex items-center bg-blue-50 dark:bg-blue-900/20 p-2 rounded-lg mr-1 transition">
                            ...
                            <tr>
                                <td colspan="4" class="px-5 py-10 text-center text-sm text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                         ...
                                         <span x-text="'Tidak ada unit ditemukan.'"></span>
                                    </div>
                                </td>
                            </tr>
                        </template>
