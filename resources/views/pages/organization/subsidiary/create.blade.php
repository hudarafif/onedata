...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <nav class="mb-6">
        <ol class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li class="flex items-center gap-2">
                ...
                <span class="text-gray-900 dark:text-white">Tambah Anak Perusahaan</span>
            </li>
        </ol>
    </nav>
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-gray-600 dark:text-gray-400">
            Tambahkan data anak perusahaan baru
        </p>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-6">
        <form action="{{ route('organization.subsidiary.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                <x-searchable-select
                    ...
                    detail-key="detail"
                    x-data="{ parent_id: '{{ old('parent_id') }}' }"
                    x-model="parent_id"
                    required
                />
