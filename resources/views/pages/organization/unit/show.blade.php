    ...
    <nav class="mb-6">
        <ol class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li class="flex items-center gap-2">
                ...
                <span class="text-gray-900 dark:text-white">Detail Unit</span>
            </li>
        </ol>
    </nav>
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
                Informasi detail unit dan daftar jabatan terkait.
            </p>
        </div>
    ...
    <div class="grid grid-cols-1 gap-6">
        <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Nama Unit</label>
                    <p class="mt-1 text-base font-semibold text-gray-900 dark:text-white">{{ $unit->name }}</p>
                </div>
                <div>
                    ...
                    <p class="mt-1 text-base text-gray-900 dark:text-white">
                        @if($unit->department)
                             ...
                             @if($unit->department->division)
                                <br><span class="text-sm text-gray-500">Divisi: {{ $unit->department->division->name }}</span>
                             @endif
                        @else
        ...
        <div x-data="unitDetails()" class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-between gap-4">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Daftar Jabatan</h2>
                ...
                <div class="flex items-center gap-3">
                    <div class="relative">
                     ...
                     <!-- Action to add position could be added here if Position module was in scope, but keeping it simple for now -->
                </div>
            </div>
                            ...
                            <tr>
                                <td colspan="3" class="px-5 py-10 text-center text-sm text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                         ...
                                         <span x-text="'Tidak ada jabatan ditemukan.'"></span>
                                    </div>
                                </td>
                            </tr>
                        </template>
